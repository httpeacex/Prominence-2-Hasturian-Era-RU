...
**3.** Скачайте [последний релиз](../../releases) или клонируйте репозиторий.

**4.** Скопируйте содержимое папки `overlay/` в корень инстанса — туда, где лежат
`mods`, `config`, `resourcepacks`. Согласитесь на замену файлов.
