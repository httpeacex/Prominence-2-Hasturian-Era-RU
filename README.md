...
Около 1,2 миллиона символов текста. Английского в игре не осталось.
...
<a href="#установка"><img src="https://img.shields.io/badge/%D0%A3%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0-2D6A9F?style=flat-square&labelColor=1C2128" height="26" alt="Установка"></a>
...
<a href="#под-капотом"><img src="https://img.shields.io/badge/%D0%9F%D0%BE%D0%B4%20%D0%BA%D0%B0%D0%BF%D0%BE%D1%82%D0%BE%D0%BC-2D6A9F?style=flat-square&labelColor=1C2128" height="26" alt="Под капотом"></a>
...
<a href="#ограничения"><img src="https://img.shields.io/badge/%D0%9E%D0%B3%D1%80%D0%B0%D0%BD%D0%B8%D1%87%D0%B5%D0%BD%D0%B8%D1%8F-8B6914?style=flat-square&labelColor=1C2128" height="26" alt="Ограничения"></a>
...
<a href="#что-переведено"><img src="https://img.shields.io/badge/%D1%81%D1%82%D1%80%D0%BE%D0%BA-25%20849-6E7681?style=flat-square&labelColor=1C2128" height="24" alt="25849 строк"></a>
...
<p align="center">
<img src="docs/overview.jpg" alt="Что переведено, установка и контроль качества" width="100%">
</p>
...
<details>
<summary><b>Подробная таблица покрытия</b></summary>
...
| ✅ | **Все моды сборки** | 22 629 ключей в 240 пространствах имён |

</details>

> [!NOTE]
> Проверены все **61 900 строк** сборки из 417 модов. Достижения, блоки, предметы,
> сущности, биомы, эффекты, вкладки инвентаря и интерфейс — **100% на русском**.
> Испанские вкладки квестбука намеренно оставлены испанскими.
...
```mermaid
flowchart LR
    A["Дистрибутив<br>v3.9.27"] --> B["extract"] --> C["3 002 строки<br>8 частей"] --> D["перевод<br>по глоссарию"] --> E["normalize"] --> F["lint → inject"] --> G(["overlay/"])
    A --> H["Puffish Skills<br>309 фраз"] --> I["assemble"] --> G
    A --> J["prominent.jar<br>320 ключей"] --> K["build"] --> G

    style A fill:#1f2937,stroke:#4b5563,color:#f9fafb
    style G fill:#14532d,stroke:#22c55e,color:#f0fdf4
```
